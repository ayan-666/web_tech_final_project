...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-md-10">
			<h2 class="text-center mt-4">Manage Quota</h2><br>
			<hr>
	...
	<div class="row">
		<div class="col-md-3 offset-md-1">
			...
			<form action="functions.php"method="post"enctype="multipart/form-data">
				...
				<div class="container">
    				<div class="form-group">
    					<label for="select1">Quota Count</label>
    			...
    			<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0-beta1/dist/js/bootstrap.bundle.min.js"></script><br>
      			<div class="form-group">
      				<input type="submit"name="remove"class="btn btn-primary btn-block"value="Remove"><br><br>
