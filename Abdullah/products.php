    ...
    <body>
        <div class="row" style="padding-top: 50px;">
            <div class="">
                ...
                <div class="card" style="background-color:#754643;">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="products.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                                <button type="submit" value="submit" name="submit" style="color:black;">Add</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <div class="table_container" style="background-color:#754643;">
                        <h1 style="text-align: center;">Products Table</h1>
                        <div class="table-responsive">
                            <table class="table table-dark" id="table" data-toggle="table" data-search="true" data-filter-control="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" style="background-color:#754643;">
                                <thead class="thead-light">
                                <tr>
                                    <th data-field="name" data-filter-control="select" data-sortable="true" style="color: white; text-align: center;">Product Name</th>
                                    <th data-field="bought" data-filter-control="select" data-sortable="true" style="color: white; text-align: center;"> Bought</th>
                                    <th data-field="sold" data-sortable="true" style="color: white; text-align: center;">Sold</th>
                                    <th data-field="stock" data-sortable="true" style="color: white; text-align: center;">Available in Stock</th>
                                    <th data-field="actions" data-sortable="true" style="color: white; text-align: center;"> Actions</th>
                                </tr>
                                </thead>
